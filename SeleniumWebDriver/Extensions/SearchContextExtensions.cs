...
namespace SeleniumWebDriver.Extensions
{
    public static class SearchContextExtensions
    {
        ...
        {
            return element.GetElement(locator, BaseConfig.LongTimeout, e => e.Displayed & e.Enabled, customMessage);
        }
        ...
        /// </returns>
        /// <example>How to use it: <code>
        /// Driver.GetElement(loginButton, timeout);
        /// </code></example>
        ...
        public static IList<IWebElement> GetElements(this ISearchContext element, ElementLocator locator, int minNumberOfElements)
        {
            ...
            WaitHelper.Wait(
                ...
                TimeSpan.FromSeconds(BaseConfig.LongTimeout),
                "Timeout while getting elements");
            return elements;
        }
